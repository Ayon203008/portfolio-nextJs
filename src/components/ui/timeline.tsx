...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    ...
    >
      ...
      {/* === Radial fade effect === */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-white dark:bg-neutral-950 [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
