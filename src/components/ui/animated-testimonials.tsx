...
type Testimonial = {
  ...
  designation: string;
  src: string;
  rating?: number; // optional rating (default 5)
};
...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-20 font-sans antialiased md:px-8 lg:px-12 
      bg-gradient-to-r from-neutral-900 via-black to-neutral-950 rounded-3xl shadow-2xl">
        ...
        <div className="flex flex-col justify-between py-4 text-white">
          ...
          >
            ...
            <div className="flex gap-1 mt-3">
              {Array.from({ length: testimonials[active].rating || 5 }).map(
                (_, i) => (
